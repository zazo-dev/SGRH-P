...
namespace SGRH.Web.Migrations
{
    ...
    [Migration("20240417032901_AddSettlementPayrollDate")]
    partial class AddSettlementPayrollDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SGRH.Web.Models.Entities.Layoff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DismissalCause")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime>("DismissalDate")
                        .HasColumnType("datetime2");

                    b.Property<bool>("HasEmployerResponsibility")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("SGRH.Web.Models.Entities.Settlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SGRH.Web.Models.Entities.Settlement", b =>
                {
                    b.HasOne("SGRH.Web.Models.Entities.Layoff", "Layoff")
                        .WithMany()
                        .HasForeignKey("LayoffId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
